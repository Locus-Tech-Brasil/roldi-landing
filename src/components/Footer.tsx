        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-primary-foreground/50 text-sm leading-relaxed">
              ...
              Protegendo o que realmente importa para você e sua família.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="font-display text-sm font-semibold text-primary-foreground mb-4">
              Navegação
            </h4>
            <nav className="space-y-2">
              {[
                ...
                { label: "Clube de Vantagens", href: "#vantagens" },
                { label: "FAQ", href: "#faq" },
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/roldiseguros?igsh=MTdqenV3dXV6aWIwdA=="
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-primary-foreground/50 hover:text-gold hover:border-gold/40 transition-all"
              >
